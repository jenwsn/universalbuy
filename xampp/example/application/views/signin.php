      ...
      <div class="d-flex flex-column align-items-center mt-3">
        ...
        <?php echo form_open('signin/index'); ?>
          <div class="form-group col-xs-5 col-lg-10 col-centered" style="width: 150%;">
              <input id="username-input" type="text" name="username" placeholder="Enter username" class="form-control" required value="<?php if (get_cookie('username')) { echo get_cookie('username'); } ?>">
          </div>
          <div class="form-group col-xs-5 col-lg-10 col-centered mt-2" style="width: 150%;">
              <input id="password-input" type="password" name="password" placeholder="Enter password" class="form-control" required value="<?php if (get_cookie('pass')) { echo get_cookie('pass'); } ?>">
          </div>
          <div class="text-center mt-3">
            <input type="checkbox" name="remember" aria-label="Checkbox for remember" value="Remember me" <?php if (get_cookie('username')) { ?> checked="checked" <?php } ?>>
