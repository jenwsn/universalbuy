...
class IpAllowDeny
{
     ...
     * @param string $ipToTest  string of IP to images against range
     *
     ...
     * @param string $ip_to_test string of IP to images against range
     *
     * @return boolean    whether the IP mask matches
     *
     * @access  public
    ...
    public function ipv6MaskTest($test_range, $ip_to_test)
    {
        ...
        if ($is_range) {
            ...
            if ($match) {
                ...
                // check if the IP to images is within the range
