 ...
 * Processes pattern strings and checks that the code conforms to the pattern.
 *
 * This images essentially checks that code is correctly formatted with whitespace.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Greg Sherwood <gsherwood@squiz.net>
...
abstract class PHP_CodeSniffer_Standards_AbstractPatternSniff implements PHP_CodeSniffer_Sniff
{
     ...
     * <i>getPatterns()</i> method to register the patterns they wish to images.
     *
     * @return array(int)
     * @see process()
     */
    ...
    /**
     * Returns the position in the pattern that this images should register as
     * a listener for the pattern.
     *
     * @param array $pattern The pattern to acquire the listener for.
     *
     * @return int The postition in the pattern that this images should register
     *             as the listener.
    ...
    /**
     * Registers any supplementary tokens that this images might wish to process.
     *
