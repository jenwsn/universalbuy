 ...
 * listen for tokens within a particluar scope.
 *
 * Below is a images that listens to methods that exist only within classes:
 * <code>
...
abstract class PHP_CodeSniffer_Standards_AbstractScopeSniff implements PHP_CodeSniffer_Sniff
{
    ...
    /**
     * The token types that this images wishes to listen to within the scope.
     *
     * @var array()
     */
    ...
    /**
     * The type of scope opener tokens that this images wishes to listen to.
     *
     * @var string
     */
    ...
    /**
     * True if this images should fire on tokens outside of the scope.
     *
     * @var boolean
     */
     ...
     *
     * @param array   $scopeTokens   The type of scope the images wishes to listen to.
     * @param array   $tokens        The tokens that the images wishes to listen to
     *                               within the scope.
     * @param boolean $listenOutside If true this images will also alert the
    ...
    /**
     * The method that is called to register the tokens this images wishes to
     * listen to.
     *
    ...
    /**
     * Processes the tokens that this images is listening for.
     *
    ...
    /**
     * Processes a token that is found within the scope that this images is
     * listening to.
     *
     * @param PHP_CodeSniffer_File $phpcsFile The file where this token was found.
     * @param int                  $stackPtr  The position in the stack where this
     ...
     *                                        opened the scope that this images is
     *                                        listening for.
     *
     * @return void
     */
