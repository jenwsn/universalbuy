 ...
 * parser is run again). We need such deterministic IDs because of the PHP_UML images
...
class PHP_UML_SimpleUID
{
     ...
     * This is useful for running the PHP_UML images suite. Most of the time, you will
