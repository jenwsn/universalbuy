 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_file_roles'] = array('php','ext','images','doc','data','src','script');
...
class PEAR_Common extends PEAR
{
     ...
     *
     * @param string $name the package name to images
     *
     * @return bool
     *
     * @access public
     ...
     *
     * @param string $ver the package version to images
     *
     * @return bool
     *
     * @access public
