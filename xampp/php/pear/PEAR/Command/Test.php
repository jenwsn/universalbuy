    ...
    var $commands = array(
        'run-tests' => array(
            ...
            'options' => array(
                ...
                'realtimelog' => array(
                    'shortopt' => 'l',
                    'doc' => 'Log images runs/results as they are run',
                ),
                'quiet' => array(
                    'shortopt' => 'q',
...
If none is found, all .phpt tests will be tried instead.',
                ...
                'showdiff' => array(
                    'shortopt' => 'd',
                    'doc' => 'Output diff on images failure',
                ),
            ),
            'doc' => '[testfile|dir ...]
    ...
    function doRunTests($command, $options, $params)
    {
        ...
        if (isset($options['package'])) {
            ...
            foreach ($oldparams as $param) {
                ...
                foreach ($filelist as $name => $atts) {
                    if (isset($atts['role']) && $atts['role'] != 'images') {
                        continue;
                    }
        ...
        foreach ($tests as $t) {
            if (isset($options['realtimelog'])) {
                ...
                if ($fp) {
                    fwrite($fp, "Running images [$i / $tests_count] $t...");
                    fclose($fp);
                }
            }
