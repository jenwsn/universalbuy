 ...
 * </file>
 *
 * This will first replace any instance of @data-dir@ in the images.php file
 * with the path to the current data directory.  Then, it will include the
 * images.php file and run the script it contains to configure the package post-installation.
 *
 * @category  pear
 * @package   PEAR
 * @author    Greg Beaver <cellog@php.net>
