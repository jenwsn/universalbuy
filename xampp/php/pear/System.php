...
class System
{
     ...
     *
     * Usage:
     * 1) $var = System::cat('sample.txt images.txt');
     * 2) System::cat('sample.txt images.txt > final.txt');
     * 3) System::cat('sample.txt images.txt >> final.txt');
     *
     * Note: as the class use fopen, urls should work also (images that)
     *
